...
async function lookupConsent(lat, lng) {
  ...
  // cowshed often falls outside it. Widen the search until we find something.
  const RADII = [0, 500, 1500, 3000];
...
function ecanTileUrl(coord, zoom, size) {
  ...
  return ECAN_BASE.replace(/\/$/, "") + "/export?" +
    ...
    "&layers=show:36,37,38&transparent=true&format=png32&dpi=96&f=image";
}
...
export default function GreenFieldsMethane() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      overlayRef.current = new EcanTiles("", { opacity: 0.55, maxZoom: 20 });
        ...
        <div className="gf-farmcols">
          ...
          <div className="gf-farmlocation">
            ...
            <label className="gf-layertoggle">
              ...
              Show ECan consented effluent disposal areas
            </label>
            {loc ? (
