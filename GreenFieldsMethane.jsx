...
//   5  = Effluent Dairy Discharge (Active)        — points
//   37 = Effluent Dairy Discharge Area (Active)   — disposal areas < 10,000 ha  << the useful one
//   38 = Effluent Dairy Discharge Global (Active) — blanket areas > 10,000 ha
// Only 37 is shaded on the map: 38 is a >10,000 ha blanket that would cover the
// whole screen. 38 is still queried, but last, as a fallback.
const ECAN_AREA_LAYER = 37;
...
function ecanTileUrl(coord, zoom, size) {
  ...
  return ECAN_BASE.replace(/\/$/, "") + "/export?" +
    ...
    "&layers=show:" + ECAN_AREA_LAYER + "&transparent=true&format=png32&dpi=96&f=image";
}
